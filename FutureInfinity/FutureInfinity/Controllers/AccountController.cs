        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        Port = 587,
                        Credentials = new NetworkCredential("thandowonke@gmail.com", "tfakicsyvxweitc"),
                        EnableSsl = true,
                    };

                    var message = new MailMessage
                    {
                        From = new MailAddress("thandowonke@gmail.com"),
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null || !(await UserManager.IsEmailConfirmedAsync(user.Id)))
                {
                    ...
                    MailMessage mm = new MailMessage("thandowonke@gmail.com", model.Email);
                    ...
                    NetworkCredential nc = new NetworkCredential("thandowonke@gmail.com", "tfakicsyvxweitc");
